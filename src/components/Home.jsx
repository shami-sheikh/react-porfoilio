...
function Home() {
  return (
    <div className="flex h-screen bg-gradient-to-b from-violet-900 to-black xl:flex-row flex-col-reverse  items-center justify-between lg:px-24 px-10 relative ">
      {/* left wala */}
      <div className="z-40 mb-[20%] xl:mb-0 ">
       ...
       transition={{
        ...
        className="text-5xl md:text-6xl lg:text-8xl font-bold z-10 ">Building Fast <br /> Reliable Result</motion.h1>
        <motion.p 
        initial={{opacity:0,y:80}}
        animate={{opacity:1,y:0}}
        transition={{
